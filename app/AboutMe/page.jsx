    ...
    <div className="flex flex-col items-center justify-center min-h-[20vh] gap-10 p-10 bg-gray-200">
      ...
      <div className="flex gap-20">
        <div className="p-1 border-4 border-gray-800 rounded-lg bg-white">
          <Image src={assets.jeeChian} alt="Jee Chian" width={350} height={350} />
        </div>
        <div className="pl-24 pt-5 max-w-4xl">
          ...
          <br />
          <h2 className="text-3xl font-bold">INTI International College Subang</h2>
          <h3 className="text-xl font-bold pt-2">Diploma In Computer Science</h3>
          <h2 className="text-4xl font-bold pt-10">Award</h2>
